    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signUp.setOnClickListener{
            ...
            if (binding.name.text.toString().equals("") ||
                binding.ageUser.text.toString().equals("") ||
                ...
                Firebase.auth.createUserWithEmailAndPassword(binding.email.text.toString(),binding.password.text.toString())
                    .addOnCompleteListener{
                        if (it.isSuccessful){
                            var user = User(binding.name.text.toString(),binding.ageUser.text.toString().toInt(),binding.email.text.toString(),binding.password.text.toString())
